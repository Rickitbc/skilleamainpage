...
const methodologySteps = [
  {
    ...
    title: "Diagnóstico",
    description:
      "Definimos objetivos y líneas base para medir progreso desde el inicio.",
  },
  {
    step: 2,
    title: "Plan de Acción",
    description:
      "Creamos un plan personalizado por etapas: foco, hábitos y entregables.",
  },
  {
    step: 3,
    title: "Ejecución",
    description:
      "Sesiones, prácticas y retroalimentación continua para avanzar cada semana.",
  },
  {
    step: 4,
    title: "Seguimiento",
    description:
      "Métricas de progreso y ajustes estratégicos para sostener resultados.",
  },
];
...
const testimonials = [
  {
    ...
    text:
      "Logré claridad para mi cambio de carrera y en 8 semanas cerré una oferta.",
  },
  {
    name: "Luis R.",
    role: "Data Analyst",
    text:
      "El plan y la mentoría me ayudaron a enfocarme y crecer con resultados.",
  },
  {
    name: "Ana P.",
    role: "UX Designer",
    text:
      "Conseguí estructura, feedback y seguridad para mis entrevistas.",
  },
];
    ...
    <div className="min-h-screen bg-[var(--skillea-cloud)] text-[var(--skillea-navy)]">
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div
              className="absolute -right-24 -top-20 w-72 h-72 bg-[var(--skillea-soft-pink)]/40 blur-3xl rounded-full"
              aria-hidden="true"
            />
            <div
              className="absolute -left-20 bottom-0 w-64 h-64 bg-[var(--skillea-star-yellow)]/30 blur-3xl rounded-full"
              aria-hidden="true"
            />
            <div className="relative grid lg:grid-cols-[1.2fr,1fr] gap-16 p-10 md:p-16 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl text-white/80 mb-8 leading-relaxed max-w-xl">
                  Impulsamos carreras a través de procesos personalizados,
                  acompañamiento experto y una comunidad vibrante lista para
                  apoyarte.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <a
                    href="#cta"
                    className="group relative inline-flex items-center justify-center gap-2 rounded-full px-8 py-4 text-[var(--skillea-navy)] font-semibold shadow-xl transition-transform focus:outline-none focus:ring-2 focus:ring-white/40"
                  >
                ...
                <div className="mt-12 grid sm:grid-cols-3 gap-6">
                  <div className="bg-white/10 border border-white/20 rounded-2xl p-5">
                    <div className="text-3xl font-bold text-[var(--skillea-star-yellow)]">
                      500+
                    </div>
                  ...
                  <div className="bg-white/10 border border-white/20 rounded-2xl p-5">
                    <div className="flex gap-1 mb-1">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className="w-5 h-5 fill-[var(--skillea-star-yellow)] text-[var(--skillea-star-yellow)]"
                        />
                      ))}
                    </div>
              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-3xl bg-white text-[var(--skillea-navy)] shadow-2xl">
                  <div
                    className="absolute -top-24 -right-16 w-48 h-48 bg-[var(--skillea-soft-pink)]/20 blur-3xl rounded-full"
                    aria-hidden="true"
                  />
                  <div className="p-10 space-y-6 relative">
                    <div>
                      <p className="text-sm font-semibold text-[var(--skillea-navy)]/60 mb-2">
                        Lo que trabajaremos
                      </p>
                    ...
                    <div className="space-y-5">
                      {[
                        ...
                        },
                        {
                          ...
                          description:
                            "Red de profesionales que impulsan tu crecimiento.",
                        },
                      ].map((item, index) => (
                    ...
                    <div className="pt-6 border-t border-[var(--skillea-ice)]">
                      <p className="text-sm text-[var(--skillea-navy)]/60 mb-2">
                        Incluye
                      </p>
                      <p className="text-base font-semibold">
                        Evaluaciones, sesiones 1:1 y acompañamiento continuo.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid gap-4">
                    {[{
                      ...
                      focus:
                        "Acompaña procesos de cambio cultural y liderazgo femenino.",
                    },
                    {
                      name: "Gustavo Mujica",
                      role: "Mentor de Carrera",
                      focus:
                        "Especialista en planes de transición hacia roles directivos.",
                    },
                    {
                      name: "Ricardo Pulgar",
                      role: "Consultor en Innovación",
                      focus:
                        "Integra metodologías ágiles para equipos orientados a resultados.",
                    }].map((member) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-[var(--skillea-navy)] shadow-sm">
              <span className="inline-block h-2 w-2 rounded-full bg-[var(--skillea-soft-pink)]" />{" "}
              Servicios
            </span>
            <h2 className="mt-6 text-4xl md:text-5xl font-bold text-[var(--skillea-navy)]">
            ...
            <p className="mt-4 text-lg text-[var(--skillea-navy)]/70">
              Diseñamos experiencias que equilibran la estrategia, el desarrollo
              de habilidades y la claridad vocacional.
            </p>
          </div>
          <div className="grid gap-8 md:grid-cols-3">
            {services.map((service, index) => (
              ...
              >
                <div
                  className="absolute -top-20 -right-20 h-40 w-40 rounded-full bg-[var(--skillea-soft-blue)]/30 blur-3xl transition-transform duration-500 group-hover:scale-125"
                  aria-hidden="true"
                />
                <div
                ...
                <p className="relative text-[var(--skillea-navy)]/70 leading-relaxed mb-6">
                  {service.description}
                </p>
                <ul className="relative space-y-3 mb-6">
                  {[
                    "Plan de desarrollo personalizado",
                    "Sesiones semanales 1-on-1",
                    "Seguimiento de metas",
                  ].map((bullet, bulletIndex) => (
                    <li
                      key={bulletIndex}
                      className="flex items-center gap-3 text-sm text-[var(--skillea-navy)]/80"
                    >
                      <CheckCircle
                        className={`w-5 h-5 ${service.bulletAccent}`}
                      />
                      <span>{bullet}</span>
                    </li>
                  ))}
                ...
                <a
                  href="#cta"
                  className="relative inline-flex items-center gap-2 text-sm font-semibold text-[var(--skillea-navy)] transition-transform group-hover:translate-x-1"
                >
                  Saber más
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="inline-flex items-center gap-2 rounded-full bg-[var(--skillea-ice)] px-4 py-2 text-sm font-semibold text-[var(--skillea-navy)]">
              <span className="inline-block h-2 w-2 rounded-full bg-[var(--skillea-star-yellow)]" />{" "}
              Metodología
            </span>
            <h2 className="mt-6 text-4xl md:text-5xl font-bold">
              Un proceso diseñado para ver resultados
            </h2>
            <p className="mt-4 text-lg text-[var(--skillea-navy)]/70">
              Acompañamos cada etapa con claridad, herramientas y seguimiento
              constante para garantizar avances sostenidos.
            </p>
          </div>
          <div className="grid gap-8 md:grid-cols-4">
            {methodologySteps.map((step, index) => (
              <div
                key={step.step}
                className="relative rounded-3xl border border-[var(--skillea-soft-blue)]/40 bg-white p-8 shadow-sm"
              >
                <div className="text-5xl font-bold text-[var(--skillea-soft-blue)]/70 mb-4">
                  {step.step}
                </div>
                <h3 className="text-xl font-semibold mb-3">{step.title}</h3>
                <p className="text-sm leading-relaxed text-[var(--skillea-navy)]/70">
                  {step.description}
                </p>
                {index < methodologySteps.length - 1 && (
                  <div
                    className="hidden md:block absolute top-1/2 right-[-20px] h-px w-10 bg-[var(--skillea-soft-blue)]/40"
                    aria-hidden="true"
                  />
                )}
              </div>
      ...
      <section id="testimonios" className="py-24 px-6 bg-[var(--skillea-ice)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="mt-6 text-4xl md:text-5xl font-bold">
              Historias de evolución profesional
            </h2>
            <p className="mt-4 text-lg text-[var(--skillea-navy)]/70">
              Profesionales que transformaron su carrera y encontraron claridad
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[var(--skillea-navy)]/60">
                      {t.role}
                    </p>
                  </div>
                </div>
        ...
        >
          <div className="px-10 py-16 md:px-20 md:py-20 text-center">
            ...
            <p className="text-lg md:text-xl text-[var(--skillea-navy)]/80 max-w-3xl mx-auto mb-10">
              Agenda una sesión gratuita y descubre cómo podemos ayudarte a
              construir el futuro profesional que imaginas.
            </p>
            <a
              href="#"
          ...
          <div className="grid gap-12 md:grid-cols-4 mb-12">
            <div>
              ...
              <p className="text-sm text-[var(--skillea-ice)]/80 leading-relaxed">
                Transformando carreras a través del coaching profesional, el
                desarrollo continuo y la claridad vocacional.
              </p>
            </div>
            <div>
